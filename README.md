...
Machine learning and train a simple model.
...
- The software must be downloaded and run on a machine as follows:
	...
	``git clone https://github.com/SeanOhAileasa/fda-models.git``

    - Run Jupyter Notebooks from the command line with the following:

	``jupyter notebook``

    - Open notebook - ``fda-models.ipynb``
...
- An alternative to downloading and running on a local machine with all features included (links/equation tag number etc) can view via [nbviewer](https://nbviewer.jupyter.org/github/SeanOhAileasa/fda-models/blob/main/fda-models.ipynb).
